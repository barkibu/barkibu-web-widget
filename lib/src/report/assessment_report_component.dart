...
@Component(selector: 'assessment-report', templateUrl: 'assessment_report_component.html', styleUrls: [
  'assessment_report_component.css'
], directives: [
  coreDirectives,
...
class AssessmentReportComponent implements OnInit, OnDestroy {
  ...
  AssessmentReportComponent(this.reportBloc, this.messages, this._config, this._parentWindow);
