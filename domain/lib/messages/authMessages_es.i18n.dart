...
class Sign_upAuthMessages_es extends Sign_upAuthMessages {
	...
	String marketing_optin_acknowledgement(String marketingBrandName, String affiliatesUrl) => "Clicando en el botón de Registro, estás indicando que te gustaría recibir información comercial de $marketingBrandName y sus <a target=_blank href='$affiliatesUrl'>afiliados</a> con ofertas especiales, lo último sobre los productos de $marketingBrandName y más.";
	String data_privacy_policy(String privacyUrl) => "Tiene que ser mayor de 16 años para suscribirte y poder suscribirte en cualquier momento. Utilizamos tu información para mejorar tu experiencia y la información que te ofrecemos; mira nuestra <a target=_blank href='$privacyUrl'>Política de Privacidad</a> para ver los detalles de cómo gestionamos tus datos.";
