...
class Sign_upAuthMessages {
	...
	String marketing_optin_acknowledgement(String marketingBrandName, String affiliatesUrl) => "By clicking on Signup, you are indicating you would like to hear from $marketingBrandName and its <a  href='$affiliatesUrl'>affiliates</a> with special offers, the latest about $marketingBrandName products and more.";
	String data_privacy_policy(String privacyUrl) => "Must be 16 or older to subscribe and may unsubscribe at any time. We may use your data for research to improve our offerings. See ou <a href='$privacyUrl'>Privacy Policy</a> for details about how we use your data.";
